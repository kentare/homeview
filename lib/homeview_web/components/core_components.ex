defmodule HomeviewWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(HomeviewWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(HomeviewWeb.Gettext, "errors", msg, opts)
    end
  end
